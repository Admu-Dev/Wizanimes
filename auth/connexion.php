...
<body>
  <div class="container">
    ...
    <form class="registration-form" method="post">
      ...
      <?php
      if (isset($er_connexion)) {
      ?>
        <div><?= $er_connexion ?></div>
      <?php
      }
      ?>
      ...
      <div class="text-center">
        <button class="submit" name="connexion">Log in</button>
      </div>

      <p class="text-center">Not a member? <a href="inscription">Sign up now</a> <svg class="icon">
          <use xlink:href="#icon-arrow-right"></use>
        </svg></p>

      <p class="text-center"><a href="forgot-password">Forgot password?</a> <svg class="icon">
          <use xlink:href="#icon-arrow-right"></use>
        </svg></p>
