...
<head>
    <!--title-->
    <title>Dashboard - Wizanimes</title>
...
<body>
    ...
    <section class="Cards-menu">
        <h2>Différentes sections du menu Admin</h2>

        <div class="container-Cards-menu">

            <a href="utilisateurs" class="div-cards">
                <div class="div-img">
                    <img src="../image/20945504.png" alt="illustration Utilisateurs" class="img-cards">
                </div>
                <div class="div-description">
                    <h3 id="h3-cards">Affichage des Utilisateurs</h3>
                </div>
            </a>

            <a href="Dashboard-Video" class="div-cards">
                <div class="div-img">
                    <img src="../image/727091cf-69db-4e6f-8f69-ee77b851091a-removebg-preview.png" alt="illustration Dashboard" class="img-Dashboard">
                </div>
                <div class="div-description">
                    <h3 id="h3-cards">Dashboard</h3>
                </div>
            </a>
