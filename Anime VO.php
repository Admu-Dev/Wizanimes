...
$afficher_anime_VO = $DB->query("SELECT * 
  FROM images WHERE categorie = 'Anime-VO'");
...
<head>
  <!--title-->
  <title>Animes VO - Wizanimes</title>
  ...
  <header class="Header">
    ...
    <div class="menu">
      ...
      <ul id="nav">
        ...
        <li><a href="./Anime VO" class="active"><i class="fas fa-globe-americas"></i>Animé VO</a></li>
