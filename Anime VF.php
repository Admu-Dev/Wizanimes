...
$afficher_anime_VF = $DB->query("SELECT * 
  FROM images WHERE categorie = 'Anime-VF'");

$afficher_anime_VF = $afficher_anime_VF->fetchAll();
...
<head>
  <!--title-->
  <title>Animes VF - Wizanimes</title>
  ...
  <header class="Header">
    ...
    <div class="menu">
      ...
      <ul id="nav">
        ...
        <li><a href="./Anime VF" class="active"><i class="fas fa-globe-europe"></i> Animé VF</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="row-inner">
          ...
          <?php
          foreach ($afficher_anime_VF as $VF) {
          ?>
            <div class="card">
              <a href="./stream/stream?id=<?= $VF['NameAnime'] ?>" class="cards-a">
                <div class="card-media">
                  <img class="card-img" src="upload/images/<?= $VF['img'] ?>" alt="" />
                </div>
